...
var sprite1, context1, texture1, canvas1, projector;
...
// Dat.Gui Events, Params, and Functions
	...
	sprite1.scale.set(6 ,3, 1.0);
	sprite1.position.set( 0, 7, -5 );
	scene.add( sprite1 );	
}//Function Init
...
function update() {
	// create a ray with origin from the mouse and direction in the scene (camera direction)
	...
	var intersects2 = ray.intersectObjects ( objects && scene.children );
